...
| completed_by_user | [`User`](user.md) | No | User that completed the task; omitted if the task wasn&#39;t completed by a user |
| completed_by_chat | [`Chat`](chat.md) | No | Chat that completed the task; omitted if the task wasn&#39;t completed by a chat |
