...
| chat_owner_left | [`ChatOwnerLeft`](chat-owner-left.md) | No | Service message: chat owner has left |
| chat_owner_changed | [`ChatOwnerChanged`](chat-owner-changed.md) | No | Service message: chat owner has changed |
...
| gift_upgrade_sent | [`GiftInfo`](gift-info.md) | No | Service message: upgrade of a gift was purchased after the gift was sent |
