---
title: "setMyDefaultAdministratorRights"
---
...
|-----------|------|----------|-------------|
| rights | [`ChatAdministratorRights`](/api/types/chat-administrator-rights/) | No | A JSON-serialized object describing new default administrator rights If not specified, the default administrator rights will be cleared. |
