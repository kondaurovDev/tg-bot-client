...
| sticker | [`InputFile`](/api/types/input-file/) | Yes | A file with the sticker in .WEBP, .PNG, .TGS, or .WEBM format See https://core.telegram.org/stickers for technical requirements More information on Sending Files » |
