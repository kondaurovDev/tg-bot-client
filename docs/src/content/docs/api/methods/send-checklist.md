...
| checklist | [`InputChecklist`](/api/types/input-checklist/) | Yes | A JSON-serialized object for the checklist to send |
...
| reply_parameters | [`ReplyParameters`](/api/types/reply-parameters/) | No | A JSON-serialized object for description of the message to reply to |
