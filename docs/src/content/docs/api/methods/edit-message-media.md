...
|-----------|------|----------|-------------|
| media | [`InputMedia`](/api/types/input-media/) | Yes | A JSON-serialized object for a new media content of the message |
...
| reply_markup | [`InlineKeyboardMarkup`](/api/types/inline-keyboard-markup/) | No | A JSON-serialized object for a new inline keyboard. |
