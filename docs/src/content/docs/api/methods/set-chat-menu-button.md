...
| menu_button | [`MenuButton`](/api/types/menu-button/) | No | A JSON-serialized object for the bot&#39;s new menu button Defaults to MenuButtonDefault |
