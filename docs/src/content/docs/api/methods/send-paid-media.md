...
| star_count | `number` | Yes | The number of Telegram Stars that must be paid to buy access to the media; 1-25000 |
| media | [`InputPaidMedia`](/api/types/input-paid-media/)[] | Yes | A JSON-serialized array describing the media to be sent; up to 10 items |
