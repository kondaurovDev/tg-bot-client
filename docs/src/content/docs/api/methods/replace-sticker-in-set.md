...
| sticker | [`InputSticker`](/api/types/input-sticker/) | Yes | A JSON-serialized object with information about the added sticker If exactly the same sticker had already been added to the set, then the set remains unchanged. |
