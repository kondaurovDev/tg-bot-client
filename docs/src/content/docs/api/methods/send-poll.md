...
| options | [`InputPollOption`](/api/types/input-poll-option/)[] | Yes | A JSON-serialized list of 2-12 answer options |
...
| question_entities | [`MessageEntity`](/api/types/message-entity/)[] | No | A JSON-serialized list of special entities that appear in the poll question It can be specified instead of question_parse_mode |
...
| explanation_entities | [`MessageEntity`](/api/types/message-entity/)[] | No | A JSON-serialized list of special entities that appear in the poll explanation It can be specified instead of explanation_parse_mode |
