...
| results | [`InlineQueryResult`](/api/types/inline-query-result/)[] | Yes | A JSON-serialized array of results for the inline query |
...
| button | [`InlineQueryResultsButton`](/api/types/inline-query-results-button/) | No | A JSON-serialized object describing a button to be shown above inline query results |
