...
| options | [`PollOption`](/api/types/poll-option/)[] | Yes | List of poll options |
...
| question_entities | [`MessageEntity`](/api/types/message-entity/)[] | No | Special entities that appear in the question Currently, only custom emoji entities are allowed in poll questions |
...
| explanation_entities | [`MessageEntity`](/api/types/message-entity/)[] | No | Special entities like usernames, URLs, bot commands, etc that appear in the explanation |
