...
| document | [`Document`](/api/types/document/) | Yes | Document with the pattern |
| fill | [`BackgroundFill`](/api/types/background-fill/) | Yes | The background fill that is combined with the pattern |
