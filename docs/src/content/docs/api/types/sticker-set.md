...
| stickers | [`Sticker`](/api/types/sticker/)[] | Yes | List of all set stickers |
| thumbnail | [`PhotoSize`](/api/types/photo-size/) | No | Sticker set thumbnail in the .WEBP, .TGS, or .WEBM format |
