...
|-------|------|----------|-------------|
| gift | [`Gift`](/api/types/gift/) | Yes | Information about the gift |
...
| prepaid_upgrade_star_count | `number` | No | Number of Telegram Stars that were prepaid for the ability to upgrade the gift |
| is_upgrade_separate | `boolean` | No | True, if the gift&#39;s upgrade was purchased after the gift was sent |
