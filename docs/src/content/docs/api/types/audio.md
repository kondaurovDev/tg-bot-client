...
| performer | `string` | No | Performer of the audio as defined by the sender or by audio tags |
| title | `string` | No | Title of the audio as defined by the sender or by audio tags |
...
| thumbnail | [`PhotoSize`](/api/types/photo-size/) | No | Thumbnail of the album cover to which the music file belongs |
