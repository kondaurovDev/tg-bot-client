...
| affiliate_user | [`User`](/api/types/user/) | No | The bot or the user that received an affiliate commission if it was received by a bot or a user |
| affiliate_chat | [`Chat`](/api/types/chat/) | No | The chat that received an affiliate commission if it was received by a chat |
