...
| chat | [`Chat`](/api/types/chat/) | Yes | Information about a chat in the business account The bot may not have access to the chat or the corresponding user. |
