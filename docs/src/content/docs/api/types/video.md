...
| thumbnail | [`PhotoSize`](/api/types/photo-size/) | No | Video thumbnail |
| cover | [`PhotoSize`](/api/types/photo-size/)[] | No | Available sizes of the cover of the video in the message |
| start_timestamp | `number` | No | Timestamp in seconds from which the video will play in the message |
| qualities | [`VideoQuality`](/api/types/video-quality/)[] | No | List of available qualities of the video |
