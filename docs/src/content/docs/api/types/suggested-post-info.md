...
| price | [`SuggestedPostPrice`](/api/types/suggested-post-price/) | No | Proposed price of the post If the field is omitted, then the post is unpaid. |
