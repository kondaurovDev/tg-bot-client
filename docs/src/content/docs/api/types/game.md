...
| photo | [`PhotoSize`](/api/types/photo-size/)[] | Yes | Photo that will be displayed in the game message in chats. |
...
| text_entities | [`MessageEntity`](/api/types/message-entity/)[] | No | Special entities that appear in text, such as usernames, URLs, bot commands, etc. |
| animation | [`Animation`](/api/types/animation/) | No | Animation that will be displayed in the game message in chats Upload via BotFather |
