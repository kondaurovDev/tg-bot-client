...
| sticker | [`Sticker`](/api/types/sticker/) | Yes | The sticker that represents the gift |
...
| background | [`GiftBackground`](/api/types/gift-background/) | No | Background of the gift |
