...
| star_amount | [`StarAmount`](/api/types/star-amount/) | No | The amount of Telegram Stars that was received by the channel; for payments in Telegram Stars only |
