...
| entities | [`MessageEntity`](/api/types/message-entity/)[] | No | Special entities that appear in the quote Currently, only bold, italic, underline, strikethrough, spoiler, and custom_emoji entities are kept in quotes. |
