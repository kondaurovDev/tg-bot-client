...
|-------|------|----------|-------------|
| chat | [`Chat`](/api/types/chat/) | Yes | The chat that created the giveaway |
...
| winners | [`User`](/api/types/user/)[] | Yes | List of up to 100 winners of the giveaway |
