...
| user | [`User`](/api/types/user/) | Yes | Business account user that created the business connection |
...
| rights | [`BusinessBotRights`](/api/types/business-bot-rights/) | No | Rights of the business bot |
