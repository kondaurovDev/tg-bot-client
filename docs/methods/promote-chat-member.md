...
| can_restrict_members | `boolean` | No | Pass True if the administrator can restrict, ban or unban chat members, or access supergroup statistics For backward compatibility, defaults to True for promotions of channel administrators |
